...
<body>
	<h1>Directores.</h1>
	<form onsubmit="return validaciondirector()" action="../control/facade.php?opc=17" method="post">
		...
		<table border="0" width="500" height="200" align="center">
			...
			<tr>
				...
				<td><input type="text" value="<?php echo $ldirector -> codigodirector;?>" name="codigodirector" id="codigodirector" maxlength="5" class="caja" /></td>
			</tr>
			<tr>
				<td class="tdTitle">Nombre</td>
				<td><input type="text" value="<?php echo $ldirector -> nombredirector;?>"name="nombredirector" id="nombredirector" maxlength="40" class="caja" /></td>
			</tr>
			<tr>
