...
<body>
	<h1>Actores.</h1>
	<form onsubmit="return validacionactor()" action="../control/facade.php?opc=2" method="post">
		<table border="0" width="500" height="200" align="center">
			...
			<tr>
				...
				<td><input type="text" name="codigoactor" id="codigoactor" maxlength="5" class="caja" /></td>
			</tr>
			<tr>
				<td class="tdTitle">Nombre</td>
				<td><input type="text" name="nombreactor" id="nombreactor" maxlength="40" class="caja" /></td>
			</tr>
			<tr>
